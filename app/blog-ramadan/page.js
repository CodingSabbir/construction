...
export default function BlogRamadanPage() {
        ...
        <div className="px-4 sm:px-20">
          <div className="grid grid-cols-12 gap-4">
            ...
            <div className="col-span-12 lg:col-span-8 lg:border-r-2">
               <div className=' px-4'>
               <h2 className=' text-lg sm:text-4xl font-semibold'>Ramadan Mubarak!!</h2>
               <p className='text-gray-500 text-sm uppercase py-4'>Posted by neabl on March 12, 2024 with 0 Comment</p>
               </div>
            <div >
            <Image className='w-full my-7 px-4' src="/img/Ramadan-facebook-post_by_NEABL.png" alt='img' width={400} height={400}/>
            </div>
