...
export default function BadshaGroupPage() {
    ...
    <div className="mb-16 mt-20 ">
      ...
      <div>
       ...
       Badsha Group
        ...
        <div className="border-b-2 flex items-center gap-3 px-4 py-4 sm:px-16">
          ...
          <FaAngleDoubleRight />
          <p className="text-sm text-gray-600 capitalize"> Badsha Group</p>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-5 px-4 sm:px-16">
        ...
        <div>
         ...
         <Devider/>
         <p className="text-sm text-gray-500 py-2">Naif Engineering & Builders Ltd has completed super flat Floor Construction about 1400000 sft in Pioneer Denim Limited, Badsha Group at Sylhet. Pioneer Denim Limited authorities will primarily benefit from the additions. Everything will be implemented, gradually, here, in the future—to keep development activities dynamic.</p>
