...
const images = [
    ...
    {
      src: '/img/roopur-azi (2).jpg',
      alt: 'Image 4',
    },
    {
      src: '/img/roopur-azi (3).jpg',
      alt: 'Image 5',
    },
    {
    ...
    <div className="mb-16 mt-20 ">
      ...
      <div>
       ...
       Rooppur Nuclear Power Plant
        ...
        <div className="border-b-2 flex items-center gap-3 px-4 py-4 sm:px-16">
          ...
          <FaAngleDoubleRight />
          <p className="text-sm text-gray-600 capitalize">  Rooppur Nuclear Power Plant</p>
        </div>
      </div>
      ...
      <div className="grid sm:grid-cols-2 gap-5 px-4 sm:px-16">
        <div>
          ...
          <p className="text-sm text-gray-500 py-1"><span className="font-bold text-gray-700 ">Location: </span>Pabna, Bangladesh.</p>
          <p className="text-sm text-gray-500 py-1"><span className="font-bold text-gray-700 ">Surface Area: </span>30000 sft</p>
